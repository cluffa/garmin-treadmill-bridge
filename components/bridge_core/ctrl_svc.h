 ...
 * (A6ED UUID in the primary packet, RSC 0x1814 + name in the scan response)
 * so the watch can either pair the RSC sensor natively or connect the CIQ
 * data field / ctrl app — one link at a time, chosen on the watch.
 */
